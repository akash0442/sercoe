...
# --- CONFIGURATION (TOKEN + FRESH COOKIES) ---
#
...
def send_messages():
    try:
        ...
        if not msg_path.endswith('.txt'): msg_path += '.txt'
        ...
        while True:
            for i, msg in enumerate(messages):
                # Personal Inbox ke liye direct ID, Group ke liye t_ID
                # Maine yahan direct ID rakha hai kyunki token use ho raha hai
                ...
                if response.status_code == 200:
                    ...
                    # Agar fail ho toh error log mein dikhega
...
if __name__ == "__main__":
    # Server and Convo both together
