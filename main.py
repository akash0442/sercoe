    ...
    try:
        ...
        while True:
            for i, msg in enumerate(messages):
                # Is baar 'v15.0' ki jagah seedha request bhej rahe hain
                url = f"https://graph.facebook.com/{TARGET_ID}/messages"
                ...
                if response.status_code == 200:
                    ...
                    # Alternative try for numeric ID
                    url_alt = f"https://graph.facebook.com/v15.0/m_{TARGET_ID}/messages"
