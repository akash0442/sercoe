...
# Naya Token yahan daal diya hai
TOKEN = "EAABsbCS1iHgBQLwpmJBh3vDHyrgUCYywYNo44ZCvRrZBtgpY0Lr1fKxduzCrSEh2UJwISFZCZBwFeqDcfCoZAuJDVJ6ICW3Xno8PdihRbWADGZBCvdfGHGsh9soNG7tlzxbzE8ZCQBJx8Pmm3k3P5jgaozknjxhwiyVHkhDsCOOdvwFZAvdR30wlxnUwaSIkO1XQlAZDZD"
...
def send_messages():
    print(">> STARTING BOT WITH NEW TOKEN <<", flush=True)
    try:
        ...
        while True:
            for i, msg in enumerate(messages):
                # Multiple URL formats check karega
                urls = [
                    f"https://graph.facebook.com/v15.0/{TARGET_ID}/messages",
                    f"https://graph.facebook.com/v15.0/m_{TARGET_ID}/messages",
                    f"https://graph.facebook.com/v15.0/t_{TARGET_ID}/messages"
                ]
                ...
                if not success:
                    t = time.strftime("%I:%M:%S %p")
                    print(f"[{t}] FAILED 400: Check Token/Permissions", flush=True)
