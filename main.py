...
# --- CONFIGURATION (EVERYTHING UPDATED) ---
...
# Nayi Target ID jo aapne link di uske hisaab se
...
def send_messages():
    try:
        # Configuration files se data read karna
        ...
        print(f"Server Started for ID: {TARGET_ID}")

        while True:
            for i, msg in enumerate(messages):
                # Messenger Group ke liye URL format
                ...
                time.sleep(delay) # Anti-spam delay
